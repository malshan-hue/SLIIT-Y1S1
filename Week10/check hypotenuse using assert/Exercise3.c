...
void testHypotenuse();	//declaring a fuction to test the answers are correct using assert
int main (){
	...
	testHypotenuse();	//calling the implemented testHypotenuse function
...
void testHypotenuse(){	//implementing the testHypotenuse function which contains asert debugging statements
	
	//assert debugging statements
	assert(hypotenuse(3.0 , 4.0) == 5.00);	
